...
print(etalon)
print("alg_S")
clean_S=cleanup(S.Algorithm_wrap(raw_vert, raw_s))
print(clean_S)
print("Alg_R")
clean_R=cleanup(R.Algorithm_wrap(raw_vert, raw_r))
print(clean_R)
print("Alg_A")
clean_A=cleanup(A.Algorithm_wrap(raw_vert, raw_a))
print(clean_A)
clean_RA=cleanup(RA.Algorithm_wrap(raw_vert, raw_ra))
print("Alg_RA")
print(clean_RA)
assert compare(clean_RA, clean_A)
assert compare(clean_A, clean_R)
assert compare(clean_R, clean_S)
